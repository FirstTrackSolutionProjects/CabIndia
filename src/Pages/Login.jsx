  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        toast.success(`🎉 Welcome back, ${response.data.user.name || 'CabIndia rider'}!`);
        navigate("/dashboard");
      } else {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div
          className="grid-bg absolute inset-0 opacity-[0.04] pointer-events-none"
          style={{
        ...
        <div className="card-anim relative w-full max-w-md z-10">
          ...
          <div
            className="h-1 w-full rounded-t-3xl bg-yellow-400"
          ...
          <div className="bg-gray-900 border border-gray-800 border-t-0 rounded-b-3xl px-8 py-10 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center gap-3 mb-8">
              ...
              <div className="text-center">
                ...
                <p className="text-white text-xs mt-1.5">Sign in to continue your journey</p>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-gray-600 text-white font-semibold text-sm py-3 rounded-xl transition-all duration-200 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed group"
            >
              {googleLoading ? (
