...
const Privacy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-800">
      ...
      <p className="mb-4">
        At <strong>YourRide</strong>, your privacy is our priority. We believe in transparency and integrity when it comes to how we collect, use, and protect your personal information. This Privacy Policy outlines our practices regarding your data and your rights concerning it.
      </p>
      ...
      <p className="mt-6 italic">Your trust drives us. Thank you for choosing YourRide.</p>
    </div>
  );
};
