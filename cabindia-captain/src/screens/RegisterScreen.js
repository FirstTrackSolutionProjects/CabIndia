...
const USER_FRIENDLY_ERRORS = {
  ...
  'Missing Fields': '📝 Please fill in all fields to create your captain account.',
...
const getFriendlyErrorMessage = (serverMessage) => {
  ...
  if (USER_FRIENDLY_ERRORS[serverMessage]) return USER_FRIENDLY_ERRORS[serverMessage];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!loginResponse.data.success) {
        Alert.alert('🔑 Login Issue', 'Please login manually after registration.');
      ...
      if (applyResponse.data.success) {
        ...
        Alert.alert('❌ Error', applyResponse.data.message || 'Failed to submit application.');
      }
    } catch (error) {
    ...
    return (
      <View style={styles.successContainer}>
        ...
        <Text style={styles.successSubtitle}>
          Thanks for joining CabIndia Captain! Our team will review your application
